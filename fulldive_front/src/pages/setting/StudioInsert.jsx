...
const studioInsert = () => {
  ...
  const submit = async (e) => {
    ...
    if (imgUrl) {
      ...
      try {
        const { data } = await axios.post(`${process.env.REACT_APP_SERVER_URL}/stage/stageImageInsert`, formData, {
          headers: {
    ...
    try {
      const { data } = await axios.post(`${process.env.REACT_APP_SERVER_URL}/stage/stageInsert`, insertData);
