...
const studioInsert = () => {
  ...
  const submit = async (e) => {
    ...
    if (imgUrl) {
      ...
      try {
        const { data } = await axios.post(`http://118.63.182.3:8880/stage/stageImageInsert`, formData, {
          headers: {
    ...
    try {
      const { data } = await axios.post(`http://118.63.182.3:8880/stage/stageInsert`, insertData);
